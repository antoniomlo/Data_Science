...
st.set_page_config(
    page_title="Análise do Airbnb - Lisboa", page_icon=":chart_with_upwards_trend:"
)

# Define o cabeçalho na sidebar
st.sidebar.markdown(
    "<div align='center'><img src='https://github.com/antoniomlo/Data_Science/blob/main/img/amlo.png?raw=true' width='100'></div>",
...
st.sidebar.markdown(
    """
<a href="mailto:antoniomlm26@gmail.com" target="_blank"><img width=35 src="https://img2.gratispng.com/20180622/gzc/kisspng-email-address-computer-icons-5b2d2a555074e4.6086280415296866133296.jpg"/></a>
<a href="https://www.linkedin.com/in/antoniomlo/" target="_blank"><img width=50 src="https://static.vecteezy.com/system/resources/previews/018/930/587/non_2x/linkedin-logo-linkedin-icon-transparent-free-png.png"/></a>
""",
    unsafe_allow_html=True,
)
